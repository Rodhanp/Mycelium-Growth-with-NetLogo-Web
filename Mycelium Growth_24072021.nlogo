...
## HOW IT WORKS
Adjust the variables before the run, then setup and grow the mycelium untill satisfactory growth.Further, setup-nutrietns and allow it to flow to observe the movement of nutrients from the hyphae
